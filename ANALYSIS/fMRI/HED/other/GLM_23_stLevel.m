...
name_ana = 'GLM-23'; % output folder for this analysis
...
for i = 1:length(param.task)
    ...
    param.modul{i} = {'ONS.modulators.trialstart',...%1
        'none',... %2
        'none',... %3
        'none'}; %6
...
%% function section
    ...
    function [] = doContrasts(subjoutdir, param, SPM)
        ...
        % con1
        Ctnames{1} = 'expected_VV';
        weightPos  = ismember(conditionName, {'task-hed.startxVV^1'}) * 1; 
        Ct(1,:)    = weightPos;
