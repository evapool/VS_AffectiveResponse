function GLM_15a_stLevel(subID) 
...
name_ana = 'GLM-15a'; % output folder for this analysis
...
%% function section
    function [SPM] = doFirstLevel(subjoutdir,subjfuncdir, name_ana, param, ~)
        ...
        % set threshold of mask!! this was bad !!! need to be updated 
        %==========================================================================
