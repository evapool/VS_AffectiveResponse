...
% get onsets for model with 2st level covariates with EMG
...
if do_covariate % covariate of interest name become folder
   ...
   covariateNames = {
    'reward-control_EMG_meancent'
    'reward-neutral_EMG_meancent'
    'Odor-NoOdor_EMG_meancent'
    'Reward_NoReward_EMG_meancent'
}; 
