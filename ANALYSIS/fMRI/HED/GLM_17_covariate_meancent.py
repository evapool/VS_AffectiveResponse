...
df01.to_csv('reward-control_EMG_meancent.txt',sep='\t', index=False)
df02.to_csv('reward-neutral_EMG_meancent.txt',sep='\t', index=False)
df03.to_csv('Odor-NoOdor_EMG_meancent.txt',sep='\t', index=False)
df05.to_csv('Reward_NoReward_EMG_meancent.txt',sep='\t', index=False)
