function GLM_21_getOnsets()

% intended for REWOD HED
% get onsets for model with PE as 1st level modulator
% Duration =1
...
for  i=1:length(subj)
    ...
    modulators.odor.RPE = modulators.odor.RPE';
    ...
    for ii = 1:length(name)
        ...
        if strcmp (nameX, 'odor')  % for structure that contains substuctures
            substr = {'RPE'};% specify the substructures names
