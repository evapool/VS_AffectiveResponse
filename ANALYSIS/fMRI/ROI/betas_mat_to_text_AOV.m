...
%con_name_orig = 'CSp-CSm';
%con_name_orig  = 'Reward1-NoReward2_10';


%% create database
in_dir        = fullfile(homedir, '/DERIVATIVES/ANALYSIS/CONJ', ROI_name, ['betas_' task]);
out_dir   = fullfile(homedir, '/DERIVATIVES/ANALYSIS/CONJ', ROI_name);
