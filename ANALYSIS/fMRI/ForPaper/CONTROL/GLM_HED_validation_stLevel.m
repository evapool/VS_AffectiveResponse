function GLM_HED_validation_stLevel(subID) 
...
mdldir   = fullfile(homedir, '/DERIVATIVES/GLM/ForPaper', 'hedonic');% mdl directory (timing and outputs of the analysis)
funcdir  = fullfile(homedir, '/DERIVATIVES/PREPROC');% directory with  post processed functional scans
name_ana = 'GLM-HED-validation'; % output folder for this analysis
