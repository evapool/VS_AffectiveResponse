function GLM_HED_validation_ndLevel()

% intended for REWOD hedonic reactivity

% get onsets of the three odor delivery to contrast odors vs odorless air
...
covdir   = fullfile (homedir, 'DERIVATIVES/GLM/ForPaper', task, 'GLM-between', 'group_covariates'); % director with the extracted second level covariates
...
if do_covariate % covariate of interest name become folder
   ...
   covariateNames = {'Odor_NoOdor'}; 
z

    % These contrast names become folders
    contrastNames = {'Reward-NoReward'};
