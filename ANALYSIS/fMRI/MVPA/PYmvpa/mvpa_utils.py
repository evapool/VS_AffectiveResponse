...
# def make_targets05(subj, glm_ds_file, mask_name, runs2use, class_dict, homedir, model):

#     start_time = time.time()
#     print 'Starting making targets',time.time() - start_time

#     onsets_folder = homedir+'DATA/brain/MODELS/RSA/'+model+'/sub-'+subj+'/glm/timing/'

#     trial_list = []
#     trial_categ_list = []
#     chunks_list = []
#     for run in range(1,4):
#         temp_folder = onsets_folder+model+'_run-0'+str(run)
#         condition = np.genfromtxt(temp_folder+'_condition.txt',dtype=None)
...
# def make_targets03(subj, glm_ds_file, mask_name, runs2use, class_dict, homedir, model):
...
# def make_targets(subj, glm_ds_file, mask_name, runs2use, class_dict, homedir, model):
...
# def make_targets2(subj, glm_ds_file, mask_name, runs2use, class_dict, homedir, model):
