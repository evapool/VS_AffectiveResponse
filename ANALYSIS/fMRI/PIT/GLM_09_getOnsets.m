...
for j = 1:length(task)
    ...
    for  i=1:length(subj)
        ...
        %-------------mob_effort
        modulators.PIT.CSp.eff      = BEHAVIOR.mobilized_effort(strcmp ('CSplus', PIT.CONDITIONS));
        modulators.PIT.CSm.eff      = BEHAVIOR.mobilized_effort(strcmp ('CSminus', PIT.CONDITIONS));
