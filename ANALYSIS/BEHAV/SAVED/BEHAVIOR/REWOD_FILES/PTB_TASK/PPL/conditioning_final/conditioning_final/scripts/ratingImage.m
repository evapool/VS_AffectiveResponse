...
% Function to draw the VAS and the image on screen
    function draw()
        ...
        Screen('DrawText', wPtr, '0', distanceFromBorderLine, verticalPosLine + 15);
        Screen('DrawText', wPtr, 'Pas du tout', distanceFromBorderLine - 30, verticalPosLine + 40); %%%%% modified by Eva
        Screen('DrawText', wPtr, '100', RectWidth(rect) - distanceFromBorderLine - 12, verticalPosLine + 15);
        Screen('DrawText', wPtr, 'Extrêmement', RectWidth(rect) - distanceFromBorderLine - 90, verticalPosLine + 40);%%%%% modified by Eva
