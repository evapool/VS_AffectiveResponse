function rate = ratingOdor(question,anchorMin, anchorMax, wPtr, rect,var) %% modified on 13.06.2015 by Eva
...
% Function to draw the VAS and the image on screen
    function draw()
        ...
        Screen('TextSize', wPtr, 18); % Maybe find a way to relate the text size and the window size.
        Screen('DrawText', wPtr, '0', distanceFromBorderLine, verticalPosLine + 15); % 15 was 5
        Screen('DrawText', wPtr, anchorMin, distanceFromBorderLine - 30, verticalPosLine + 40); %%40 was 35
        Screen('DrawText', wPtr, '100', RectWidth(rect) - distanceFromBorderLine - 12, verticalPosLine + 15); % 15 was 5
        Screen('DrawText', wPtr, anchorMax, RectWidth(rect) - distanceFromBorderLine - 170,verticalPosLine + 40);%% 30 was 35
