    ...
    function mobforce = pressingNoReward (duration,Nloops,var,wPtr) % modified on 18.05.2015
        ...
        while toc <= duration
            ...
            val =  readAD(); % added -var.ValMax beause it reads the signal in the opposite way
            mobforce(mfexp) = val;
