    function [mobforce,rewardcount,RewardWindowDuration,tValveOpen,tValveClose] = pressingReward (Nloops,rewardcount,target,var,wPtr)   % modified on 18.05.2015
        ...
        while toc <= 1
            ...
            val = readAD();
            mobforce(mfexp) = val ;% added -var.ValMax beause it reads the signal in the opposite way
