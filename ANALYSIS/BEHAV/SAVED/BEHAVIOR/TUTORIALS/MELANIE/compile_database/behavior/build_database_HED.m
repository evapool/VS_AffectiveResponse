...
for i = 1:length(subj)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%  get durations
    DURATIONS.trialstart  = data.Durations.asterix1 + data.Durations.asterix2; % what is asterix 3 and 4?
    ...
    phase = {'trialstart';'liking'; 'intensity';'familiarity'; 'rince'; 'ITI'};
    ...
    fprintf (fid, '%s   %s   %s   %s   %s   %s   %s\n',...
        ...
        'condition','perceived_liking','perceived_intesity', 'perceived_familiarity');
...
for ii = 1:length(list)
    ...
    stnd.(conditionX).control= nanstd(ratings.(conditionX).reward,1)/sqrt(length(subj));
