...
# stat
PIT.aov <- aov_car(n_grips ~ condition*trialxcondition + Error (id/condition*trialxcondition), data = PIT.s, anova_table = list(correction = "GG", es = "pes"))
PIT.emm     <- emmeans(PIT.aov, ~ trialxcondition , model = "multivariate")
PIT.linear  <- contrast(PIT.emm, "poly") # look only at the weights for linear constrast here

PIT.s$extinction[PIT.s$trialxcondition == '1']   <- -7
PIT.s$extinction[PIT.s$trialxcondition == '2']   <- -6
PIT.s$extinction[PIT.s$trialxcondition == '3']   <- -5
PIT.s$extinction[PIT.s$trialxcondition == '4']   <- -4
PIT.s$extinction[PIT.s$trialxcondition == '5']   <- -3
PIT.s$extinction[PIT.s$trialxcondition == '6']   <- -2
PIT.s$extinction[PIT.s$trialxcondition == '7']   <- -1
PIT.s$extinction[PIT.s$trialxcondition == '8']   <- -0
PIT.s$extinction[PIT.s$trialxcondition == '9']   <- 1
PIT.s$extinction[PIT.s$trialxcondition == '10']   <- 2
PIT.s$extinction[PIT.s$trialxcondition == '11']   <- 3
PIT.s$extinction[PIT.s$trialxcondition == '12']   <- 4
PIT.s$extinction[PIT.s$trialxcondition == '13']   <- 5
PIT.s$extinction[PIT.s$trialxcondition == '14']   <- 6
PIT.s$extinction[PIT.s$trialxcondition == '15']   <- 7


PIT.aov <- aov(n_grips ~ condition*extinction + Error (id/condition*extinction), data = PIT.s)
# follow up
PIT.aov.CSplus <- aov(n_grips ~ extinction + Error (id/extinction), data = subset(PIT.s, condition == 'CSplus'))
PIT.aov.CSminus <- aov(n_grips ~ extinction + Error (id/extinction), data = subset(PIT.s, condition == 'CSminus'))
...
HED$trialxcondition <- factor(HED$trialxcondition) # to discuss
...
INST$trial                    <- factor(INST$trial) # to discuss
